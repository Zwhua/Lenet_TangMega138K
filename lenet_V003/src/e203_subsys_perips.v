...
module e203_subsys_perips(
  ...
  input  clk,
  input  uart_clk,  // UART dedicated 24 MHz clock
  input  bus_rst_n,
  input  rst_n
  );
...
sirv_uart_top u_sirv_uart0_top (
    .clk           (clk),  // Use same clock as CPU to avoid CDC issues
    .rst_n         (bus_rst_n),
...
*/
  ...
  conv1_accel_icb #(
    ...
    // 使用 PWM2 的 ICB 端口 (O11)
    .i_icb_cmd_valid (pwm2_icb_cmd_valid),
    .i_icb_cmd_ready (pwm2_icb_cmd_ready),
    .i_icb_cmd_addr  (pwm2_icb_cmd_addr ), // [31:0]
    .i_icb_cmd_read  (pwm2_icb_cmd_read ),
    .i_icb_cmd_wdata (pwm2_icb_cmd_wdata), // [31:0]
    // 如果加速器需要 wmask,请添加 .i_icb_cmd_wmask (4'hF),  // 全写使能
