...
// Lenet 加速器地址定义 (替换 PWM2: 0x1003_5000)
`define E203_CFG_LENET_ADDR_BASE  `E203_CFG_ADDR_SIZE'h1003_5000
    // 覆盖 0x1003_0000~0x1003_FFFF (64KB)，容纳 input/weight/bias/output 缓冲
    `define E203_CFG_LENET_BASE_REGION  `E203_CFG_ADDR_SIZE-1:16
