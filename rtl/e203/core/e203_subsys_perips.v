...
// ===========================================================================
// Custom Peripheral Instantiation (LeNet Accelerator)
// ===========================================================================
conv1_accel_icb u_conv1_accel_icb (
    .clk             (clk),
    .rst_n           (rst_n),

    // 连接到 ICB 总线通道 5 (对应 u_sirv_ppi_fab 的 o5 端口)
    // 注意：这里使用 e203_subsys_perips.v 中定义的信号名称 my_periph_icb_*
    ...
    .i_icb_rsp_err   () // 总线侧 o5_icb_rsp_err 已接地，此处悬空即可
);
